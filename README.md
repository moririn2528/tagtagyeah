...
heroku 上で動かしているアプリのリンク
https://tagtagyeah.herokuapp.com/

概要、工夫したところについて
https://moririn2528.hatenablog.com/entry/2021/10/30/061430

## 検索について
2 グラムで検索する。検索ワード、タグ名などすべて文字列が小さいから 0 か 1 かしかない。大小関係なら足し算で構わない。


データベースの無料で使えるバイト数が小さいので、2 グラムにした文字を保存せず、検索時に分割することにした。
...
- limit: 出力するタグの数の上限。省略した時は 100 となる。

search_phrase, limit ともに省略した時、すべてのタグを返す。
